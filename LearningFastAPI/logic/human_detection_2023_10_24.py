...
def record_video(camera_id, video_path):
    ...
    out = cv2.VideoWriter(video_path, fourcc, 4, (frame_width, frame_height))
    for frame in frames:
        out.write(frame)
    out.release()
    ...
    for r in results:
        ...
        if IS_PERSON_IN_DANGER[camera_id]:
            ...
            if IS_PERSON_REMAIN_IN_DANGER[camera_id]:
                ...
                video_path = f"/var/www/camera_{camera_id}_{datetime.datetime.utcnow().microsecond}_video.avi"
