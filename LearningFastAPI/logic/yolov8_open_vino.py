...
camera_streams = VideoStream("rtsp://admin:Trace3@123@192.168.1.64:554").start()
...
def main():
    while True:
        ...
        if frame is None:
            ...
            cv2.imshow('my webcam', image_with_boxes)
            if cv2.waitKey(1) == 27:
                break  # esc to quit
            # print("successfully")
...
if __name__ == '__main__':
    main()
# results = ov_model.predict('https://ultralytics.com/images/bus.jpg')
